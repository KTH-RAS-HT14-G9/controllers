...
public:
        ...
        left_pwm(0), right_pwm(0)
    {
        ...
        left_controller = new pid_1d(left_kp, left_ki, left_kd);
        right_controller = new pid_1d(right_kp, right_ki, right_kd);
    ...
    void update_pid_params()
    {
        ...
        ros::param::getCached(p_l_key, left_kp);
        ros::param::getCached(p_r_key, right_kp);
        ros::param::getCached(d_l_key, left_kd);
        ros::param::getCached(d_r_key, right_kd);
        ros::param::getCached(i_l_key, left_ki);
        ros::param::getCached(i_r_key, right_ki);
